...
> 本页是 Deeper 社媒 IP 的剧情检索入口。人物、世界观、视觉语法与产品表达边界以 [[Deeper社媒IP-初始设定模板-v1.0]] 为准；本页只管理故事资产，不擅自决定发布集数。

## 使用规则

1. `STORY ID` 是稳定的故事资产编号，不随发布顺序改变。
2. `EP 编号` 只有在发布排期正式确认后才填写，避免同一 EP 指向多个故事。
3. 开发分镜、提示词或续集时，先打开本页，再进入对应剧情母版。
4. 产品功能、支持平台、节点、UI 和绝对化表述必须在发布前重新核验。
5. “待开发卖点”不是已确认剧情，不得直接当成母版投入制作。

## 已归档故事

| STORY ID | 工作标题 | 核心价值 / 喜剧发动机 | 建议时长 | 当前状态 | 剧情入口 |
|---|---|---|---:|---|---|
...
| 想表达的卖点 | 优先故事 | 主要角色 | 结尾笑点 |
|---|---|---|---|
| 品牌速度感 / Dex 与 Hank 的人物关系 | DN-STORY-001 | Dex、Hank | Dex 黑屏后仍小声嘴硬 |
| 全球路由 / 数字空间重构 | DN-STORY-002 | Dex、Mary | 世界变了，家务没有消失 |
...
- 旅行 / Deeper Air：在酒店或旅途中恢复熟悉的数字生活环境。

候选母题与栏目机制继续参考 [[Deeper Network_品牌短剧与推广创意框架-2026-09-12]]，不得把“栏目方向”误写成已经确认的单集剧情。

## 当前版本风险

- `Hey, Neighbor!` 和 `Ad Invasion` 的旧生产资料都曾使用 `EP03`；正式排期未确认前，一律用 `DN-STORY-003` 与 `DN-STORY-004` 区分。
- DN-STORY-001 的四个成片尚未唯一标记正式发布母版。
...
```markdown
# Deeper 社媒 IP｜DN-STORY-___｜工作标题

- 状态：灵感 / 梗概 / 已确认母版 / 分镜中 / 制作中 / 已成片
- 发布集数：待定
- 唯一产品价值：
- 依据设定：[[Deeper社媒IP-初始设定模板-v1.0]]
...
相关：[[Deeper社媒IP-初始设定模板-v1.0]] · [[AI账号运营 Index]] · [[知识库总索引]]
